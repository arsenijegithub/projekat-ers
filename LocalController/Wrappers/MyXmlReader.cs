    ...
    public class MyXmlReader
    {
        ...
        public virtual List<LocalDeviceClass> UcitajXml(string path) 
        {
            ...
            foreach (XmlNode node in doc.DocumentElement.ChildNodes)
            {
                ...
                double workAmmount = Convert.ToDouble(node.ChildNodes[7].InnerText);
                LocalDeviceClass device = new LocalDeviceClass(Id, Type, Timestamp, Value, WorkTime, Configuration,workAmmount);
